...
* 330毫秒启动无广告, 多搜索框独立切换,简单/直接/方便/小

  (2021年的红米11pro, 330ms启动; 2019年的米8se, 503ms启动,)
  不收集用户信息,没有新闻/视频等内容推送,文件仅3.1M
...
> 9.9元/年, 现在优惠期**2年9.9元**,买一送一.
> 付费用户, 桌面布局M\*N不限,单个文件夹容量最大可达81,桌面可有多页.

> 普通用户不用登录注册,2个月试用期,功能和付费用户一样.
> 之后,桌面布局5*7,单个文件夹容量9,桌面仅1页,共可收纳315个图标,一般用户根本用不完.
